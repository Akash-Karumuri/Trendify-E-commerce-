...
const AddPant = () => {
   ...
   const AddNewPants = (e) => {
    e.preventDefault();
    axios.post(`http://localhost:4000/Pants`, {name, description, price, originalPrice, discount, image, material, colors, sizes, rating})
    .then((res) => {
  ...
  return (
    <div className='container col-lg-6 mx-auto shadow p-5 m-5'>
      <h2 className='text-center'>Add New Pants</h2>
      <form onSubmit={AddNewPants}>
